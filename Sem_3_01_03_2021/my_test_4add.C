...
//   histograms
  ...
  h_003 = new TH2F("h_003", "mass(pi+pi0) squared", 72, 0.0, 0.36, 72, 0.0, 0.36);
  h_004 = new TH2F("h_004", "mass(pi-pi0) squared",162, 0.0, 0.81, 162, 0.0, 0.81);
//   loop over events
...
//  user's code
        float  fm3 = 0;
        fm3 = TMath::Sqrt(   (e1+e2+e3)*(e1+e2+e3) 
        ...
        if(0.540<fm3 && fm3<0.570) {
//  calculate mass(1+3) sqared and mass(1+3) sqared and fill 2-dim. h_003
//        float fm23sq = (e2+e3   )*
//                         
//                        
//                       
...
//                        
//                       
//        h_003 -> Fill( fm13sq, fm23sq );
        }
        if(0.795<fm3 && fm3<0.830) {
//  calculate mass(1+3) sqared and mass(1+3) sqared and fill 2-dim. h_004
//        float fm23sq = (e2+e3   )*
//                         
//                        
//                       
...
//   end of loop over events
 h_001->Draw();
 h_002->Draw();
   TLine    line1(0.530, 0.0, 0.530, 2000.);
    cout << " in TLine" << endl;
    line1.Draw();
}
